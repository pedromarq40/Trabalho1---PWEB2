        ...
        <div className="mx-auto max-w-6xl">
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                ...
                <p className="max-w-xl text-lg leading-8 text-slate-300">
                    Plataforma moderna para gerenciar consultas, equipes e pacientes. Escolha sua jornada e faça login como administrador, médico ou paciente.
                </p>
                <div className="grid gap-4 sm:grid-cols-3">
                    <button className="rounded-full bg-sky-500 px-6 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-slate-950 transition hover:bg-sky-400">
                    Admin
                    </button>
                    <button className="rounded-full bg-slate-700/80 px-6 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-slate-600/95">
                    Médico
                    </button>
                    <button onClick={() => navigate("cadastro-paciente")} className="rounded-full bg-slate-700/80 px-6 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-slate-600/95">
                    Paciente
                    </button>
                </div>
                </div>
