/*
  ...
  - You are about to drop the column `pescricao` on the `Atendimento` table. All the data in the column will be lost.
  - Added the required column `prescricao` to the `Atendimento` table without a default value. This is not possible if the table is not empty.
